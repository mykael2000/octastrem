    ...
    <div class="container">
            ...
            <div class="col-lg-4">
                <div class="widget">
                    ...
                    <ul class="list-unstyled social">
                        ...
                        <li><a href="https://x.com/Octastrem?s=11"><span class="icon-twitter"></span></a></li>
                        <!-- <li><a href="https://www.facebook.com/Octastrem.?mibextid=2JQ9oc"><span
        ...
        <div class="row mt-5">
            <div class="col-12 text-center">
                <p class="text-white">Copyright &copy;2024 All Rights Reserved. &mdash; Octastrem.</p>
            </div>
        </div>
    </div> <!-- /.container -->
</div> <!-- /.site-footer -->
