                ...
                <div class="accordion" id="faqAccordion">
                    ...
                    <div class="card">
                        <div class="card-header" id="faqHeading1">
                            <h5 class="mb-0">
                                <button style="background-color: #fff; color: black;" class="btn btn-link" type="button"
                                    ...
                                    Is Octastrem a registered company?
                                </button>
                            </h5>
                        </div>
                        ...
                        <div id="faqCollapse1" class="collapse show" aria-labelledby="faqHeading1"
                            ...
                            <div class="card-body">
                                Yes, Octastrem is a registered and legitimate company. We are fully compliant with all
                        ...
                        <div class="card-header" id="faqHeading2">
                            <h5 class="mb-0">
                                <button style="background-color: #fff; color: black;" class="btn btn-link" type="button"
                                    ...
                                    How does Octastrem earn profits for its members?
                                </button>
                            </h5>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div id="faqCollapse15" class="collapse" aria-labelledby="faqHeading15"
                            ...
                            <div class="card-body">
                                ...
                                can
                                send an email to support@octastrem.com.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header" id="faqHeading16">
                            <h5 class="mb-0">
                                <button style="background-color: #fff; color: black;" class="btn btn-link" type="button"
                                    ...
                                    What do I need to trade on Octastrem?
                                </button>
                            </h5>
                        </div>
                        ...
                        <div id="faqCollapse16" class="collapse" aria-labelledby="faqHeading16"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                To start trading on Octastrem, you need to create an account, make a deposit, and then
                                you
                    ...
                    <div class="card">
                        <div class="card-header" id="faqHeading17">
                            <h5 class="mb-0">
                                <button style="background-color: #fff; color: black;" class="btn btn-link" type="button"
                                    ...
                                    How does trading work on Octastrem?
                                </button>
                            </h5>
                        </div>
                        ...
                        <div id="faqCollapse17" class="collapse" aria-labelledby="faqHeading17"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                Trading on Octastrem involves buying and selling various assets, such as cryptocurrencies
                    ...
                    <div class="card">
                        ...
                        <div id="faqCollapse20" class="collapse" aria-labelledby="faqHeading20"
                            ...
                            <div class="card-body">
                                ...
                                auto trading, but some prohibit it for their clients. When you’re trading with Octastrem
                    ...
                    <div class="card">
                        <div class="card-header" id="faqHeading22">
                            <h5 class="mb-0">
                                <button style="background-color: #fff; color: black;" class="btn btn-link" type="button"
                                    ...
                                    How to view Withdrawal status at Octastrem
                                </button>
                            </h5>
                        </div>
                        ...
                        <div id="faqCollapse22" class="collapse" aria-labelledby="faqHeading22"
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                Web: Octastrem home page > Withdraw > Check the order status in the withdrawal history
                                <br>
                                ...
                                Octastrem customer service, and we will process it as soon as possible.
                                <br>
                                3. Completed: Your withdrawal has been processed, and you can check the status on the
                                external exchange
                                <br>
                                If the Octastrem status shows success/completed, but you have not received the transfer,
