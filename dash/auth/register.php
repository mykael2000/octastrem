    ...
    if (mysqli_num_rows($res_e) > 0) {
        ...
        if ($password = $c_password) {
            ...
            try {
                ...
                //Recipients
                $mail->setFrom('support@octastrem.com', 'Support');
                $mail->addAddress($email); //Add a recipient               //Name is optional

                $mail->addCC('support@octastrem.com');
...
<body style="margin: 0; padding: 0; background-color: #fff; height: 100%; width: 100%;">
    <div style="display: flex; justify-content: center;">
        <img src="https://octastrem.com/Octastremlogowhite.png" alt="logo" />
    </div>
    <div style="background-color: #09055e; padding: 5rem 0;" class="header">
        <ul style="list-style-type: none; padding: 0; margin: 0; text-align: center;">
            <li style="display: inline-block; margin-right: 1rem;">
                <a style="color: #fff;" href="https://octastrem.com/dash/auth/login.php">My account</a>
            </li>
            <li style="display: inline-block; margin-right: 1rem;">
                <a style="color: #fff;" href="https://octastrem.com/faq.php">FAQ</a>
            </li>
            <li style="display: inline-block;">
                <a style="color: #fff;" href="https://octastrem.com/about.php">About Us</a>
            </li>
        </ul>
    </div>
    <div style="position: relative; top: -30px; padding-top: 20px; padding-bottom: 20px;" class="container">
        ...
        <a style="background-color:#060c39;color:#ffff; padding:15px; text-decoration:none;border-radius: 10px;font-size: 20px;" href="https://octastrem.com/dash/auth/verify-email.php?email=' . $email . '" class="btn btn primary">Verify Email</a>
        <div class="container">
            <div class="container text-center">
                <div class="row">
                    <div class="col">
                        <img src="https://octastrem.com/mail-images/smart.png" />
                        <h5 style="font-weight: 800;">SmartTrade</h5>
                        <p>An exclusive Octastrem feature that pairs with TradingView indicators that lets users view
                            multiple signals from one place.</p>
                    </div>
                    <div class="col">
                        <img src="https://octastrem.com/mail-images/dca.png" />
                    ...
                    <div class="col">
                        <img src="https://octastrem.com/mail-images/grid.png" />
        ...
        <div class="footer" style="text-align: center;">
            <div style="display: flex; justify-content: center;">
                <a class="p-2" href=""><img src="https://octastrem.com/mail-images/facebook.png" alt="" /></a>
                <a class="p-2" href=""><img src="https://octastrem.com/mail-images/instagram.png" alt="" /></a>
                <a class="p-2" href=""><img src="https://octastrem.com/mail-images/linkedin.png" alt="" /></a>
            </div>
            <div>
                <p style="font-size: 12px; font-weight: 400; color: black; font-family: Aileron; text-decoration: underline; word-wrap: break-word;">
                    Copyright © 2024 Octastrem All rights reserved
                </p>
                <div style="display: flex; justify-content: center;">
...
<head>
    ...
    <meta name="description"
        content="Octastrem is an automated  online trading  platform made so even investors with zero trading experience  are successfully making a profit">
    <meta name="keywords" content="Octastrem, octastrem.com, crypto, bitcoin">
    <link href="" rel="icon">
    <title>Octastrem | Register</title>
