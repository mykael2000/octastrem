...
if (isset($_POST['submit'])) {
    ...
    echo "<script>alert('KYC Documents uploaded successfully')</script>";
    header("refresh: 1; url=../user-area/dashboard.php");
...
<head>
    ...
    <meta name="description" content="With Octastrem your money works for you!">
    <meta name="keywords"
        content="Octastrem, octastrem.com, ethereum invesment, bitcoin investment, stock investment, Octastrem">
    <link href="../storage/logos/N6PlpwsHVj4wa0MfeGD1iOzwj9fxwGzOjdHd9LhW.png" rel="icon">
    <title>Octastrem Investment | Verify KYC</title>
