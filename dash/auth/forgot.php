...
if (isset($_POST['submit'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        <body style="background-color: #474d80; padding: 45px;">
            <div>
                <img style="position:relative; left:35%;" src="https://octastrem.com/img/logo.png">
                <h3 style="color: black;">Mail From support@octastrem.com - Reset Password</h3>
            </div>
            <div style="color: #ffff;"><hr/>
                ...
                <p></p
                <a style="background-color:#060c39;color:#ffff; padding:15px; text-decoration:none;border-radius: 10px;font-size: 20px;" href="https://octastrem.com/dash/auth/reset-password.php?email=' . $email . '" class="btn btn primary">Reset password</a>

                <h5>Note : the details in this email should not be disclosed to anyone</h5>

            </div><hr/>
                <div style="background-color: white; color: black;">
                    <h3 style="color: black;">support@octastrem.com<sup>TM</sup> - Phone : +13524965199</h3>
                </div>
