...
<body style="background-color: #474d80; padding: 45px;">
    <div>
        <img style="position:relative; left:35%;" src="https://octastrem.com/Octastremlogo.png">
        <h3 style="color: black;">Mail From support@octastrem.com - Two factor</h3>
    </div>
            ...
            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12">
                <div class="panel panel-primary" id="locked-screen">
                    <div class="panel-heading">
                        <h3 class="panel-title">Octastrem - Two factor authentication</h3>
                    </div>
