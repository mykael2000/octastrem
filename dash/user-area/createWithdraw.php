...
<body style="background-color: #474d80; padding: 45px;">
    <div>
        ...
        <h3 style="color: black;">Mail From support@octastrem.com - OTP required</h3>
    </div>
    <div style="color: #ffff;"><hr/>
       ...
       <br><br> <h5>Note : the details in this email should not be disclosed to anyone</h5>
        ...
        <div style="background-color: white; color: black;">
            <h3 style="color: black;">support@Octastrem<sup>TM</sup> - Phone : +17577423555</h3>
        </div>
...
<head>
    ...
    <link href="" rel="icon">
    <title>Octastrem - withdrawal</title>
