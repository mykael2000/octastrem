...
<div id="main-wrapper">
          ...
          <div class="col-xxl-12">
             <div class="header-content">
                <div class="header-left">
                   <div class="brand-logo"><a class="mini-logo" href="index-2.html"><img src="Octastremlogoi.png" alt="" width="40"></a></div>
                   <div class="search">
                      <form action="#">
    ...
    <div class="sidebar">
    <div class="brand-logo"><a class="full-logo" href="index-2.html"><img src="Octastremlogoi.png" alt="" width="30"></a></div>
    <div class="menu">
        <ul>
            <li><a href="index.php">
