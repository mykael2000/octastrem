...
if (isset($_POST['edit'])) {
    ...
    if ($newstatus == "completed") {
        $upsql = "UPDATE clients set pending_withdrawal = '$newpend' WHERE id = '$userid'";
...
<body class="dashboard">
    ...
    <div id="main-wrapper">
                        ...
                        <div class="header-content">
                            <div class="header-left">
                                <div class="brand-logo"><a class="mini-logo" href="index-2.html"><img
                                            src="Octastremlogoi.png" alt="" width="40"></a></div>
                                <div class="search">
                                    <form action="#">
                            ...
                            <div class="header-right">
                                ...
                                <div class="dropdown profile_log dropdown">
                                    ...
                                    <div tabindex="-1" role="menu" aria-hidden="true"
                                        ...
                                        <a class="dropdown-item" href="profile.html"><span><i
                                                    class="ri-user-line"></i></span>Profile</a>
                                        <a class="dropdown-item" href="balance.html"><span><i
                                                    class="ri-wallet-line"></i></span>Balance</a>
                                        <a class="dropdown-item" href="settings-profile.html"><span><i
                                                    class="ri-settings-3-line"></i></span>Settings</a>
                                        <a class="dropdown-item" href="settings-activity.html"><span><i
                                                    class="ri-time-line"></i></span>Activity</a>
                                        <a class="dropdown-item" href="lock.html"><span><i
                                                    class="ri-lock-line"></i></span>Lock</a>
                                        <a class="dropdown-item logout" href="signin.html"><i
        ...
        <div class="sidebar">
            <div class="brand-logo"><a class="full-logo" href="index-2.html"><img src="Octastremlogoi.png" alt=""
                        width="30"></a></div>
            <div class="menu">
                <ul>
                    <li><a href="index.php">
                    ...
                    <div class="row align-items-center justify-content-between">
                        ...
                        <div class="col-auto">
                            <div class="breadcrumbs"><a href="#">Home </a><span><i
                                    ...
                                    href="edit.php?id=<?php echo $userid; ?>">Dashboard</a><span><i
                                ...
                                <form method="post" action="" name="myform" class="personal_validate"
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-xxl-6 col-xl-6 col-lg-6">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $created_at; ?>"
                                                disabled>
                                        </div>

                                        <div class="col-12">
                                            <button name="edit" class="btn btn-primary pl-5 pr-5">Edit
                                                Withdrawal</button>
                                        </div>
                                    </div>
                                </form>
