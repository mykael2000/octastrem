...
<body>
            ...
            <div id="row-image" class="row align-items-center justify-content-between pt-3">
                <div class="col-lg-8 text-center text-lg-start pe-lg-5">
                    ...
                    <p style="color: black; font-size: 18px; font-weight: 700; padding: 7px;" class="mb-8 text-black"
                        ...
                        <span style="color: black; line-height:2;">Octastrem is the global leader in Bitcoin and
            ...
            <div class="row">
                ...
                <div class="col-lg-5 pe-lg-5">
                    <div class="mb-5">
                        ...
                        <p>Whether you are through our API website, Octastrem leading trading
    ...
    <div class="section sec-features">
        <div class="container ">
            <div class="row mb-5">
                <h2 style="color: #030769" class="d-flex justify-content-center">How does Octastrem sercure user data?
                </h2>
                <p class="d-flex justify-content-center">On top of using the three key secure connection protocols
                    explained
                    above.
                    <br>Octastrem secures user data with tools from security services provider Cloudfare.
                    <br>including:
                </p>
            </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                    <div class="feature d-flex">
                        ...
                        <div>
                            <span> Create a free account instantly with Octastrem. This process only takes 3 - 5 minutes
                                to
                                complete.
                            </span>
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="feature d-flex">
                        <i class="fa-solid fa-check-double"></i>
                        <div>
                            <span>Credit your wallet and start earning with Octastrem.
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <div class="section sec-features">
        <div class="container">
            <h2 style="color: #030769" class="d-flex justify-content-center">Octastrem helps traders win regardless of
                market
                conditions
            </h2>
            <p class="row mb-5 p-2 d-flex justify-content-center">For every market condition, there’s a trading strategy
                that can profit from it. <br>Octastrem trading bots happen to be really good at reducing average
                acquisition
                    ...
                    <div class="feature d-flex">
                        <div class="feature">
                            ...
                            <p style="color: black">Uses Grid bots to pick up coin when they hit support levels and sell
                                ...
                                profits by leveraging the power of the Octastrem trading platform</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="feature d-flex">
                        <div class="feature">
                            ...
                            <p style="color: black">With Octastrem, You can fully automate your trading, this way and it
                                gives you the
                                opportunity
    ...
    <div class="section sec-features">
        <div class="container">
            ...
            <p class="row mb-5 p-2 d-flex justify-content-center">Octastrem believes there is no better advertisement
                than
                ...
                a
                high commission rate, customized tools and reports, and timely commission payouts. Octastrem is paying
                for
                the
