...
<body>
    <div class="d-flex justify-content-center">
        <img src="https://octastrem.com/Octastremlogo.png" alt="logo" />
    </div>
        ...
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a style="color: #fff;" class="nav-link active" aria-current="page"
                    href="https://octastrem.com/dash/auth/login.php">My account</a>
            </li>
            <li class="nav-item">
                <a style="color: #fff;" class="nav-link" href="https://octastrem.com/faq.php">FAQ</a>
            </li>
            <li class="nav-item">
                <a style="color: #fff;" class="nav-link" href="https://octastrem.com/about.php">About Us</a>
            </li>
        </ul>
        ...
        <div class="footer">
            ...
            <div>
                <p class="section-body text-center">
                    ©2017 Octastrem All rights reserved
                </p>
                <div class="d-flex justify-content-center">
